...
export interface ModalState {
  ...
  openMermaidModal: (code: string) => void;
...
export const useModalStore = create<ModalState>((set, get) => ({
  ...
  openMermaidModal: (code: string) => {
    set({ isMermaidModalOpen: true, mermaidCodeForModal: code });
  },
  closeMermaidModal: () => {
    set({ isMermaidModalOpen: false, mermaidCodeForModal: '' });
  },
}));